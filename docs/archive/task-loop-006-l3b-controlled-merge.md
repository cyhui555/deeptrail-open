...
后续入口先由 [TASK-LOOP-007](task-loop-007-autonomous-intake.md) 建立只读 Intake，再由 [TASK-LOOP-008](../issues/task-loop-008-work-item-proposal.md) 生成固定草案；自动审批、自动合并、管理员绕过、force-push 和自动部署继续禁止。
