# ADR：L3B 仅在人工批准与必需检查后受控合并（历史归档）

- 状态：Engine 已交付并保持默认关闭；activation 已终止
- 日期：2026-07-18
...
- G3 未执行：Engine PR #43 已合入，activation PR #44 关闭未合入，GitHub #41 以 `not_planned` 终止；人工 Review/Merge 保持唯一合入路径。
