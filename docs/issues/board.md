...
- `BUG-20260718-003`：生产 E2E 五项根因已在单一集成分支修复并通过本地全门禁，等待 Draft PR 人工 Review/Merge，见[活动 Work Item](bug-20260718-003-production-e2e-remediation.md)与[执行计划](../plans/bug-20260718-003-production-e2e-remediation.md)。
