...
- `TASK-LOOP-003`：PR #22–#31、不可变发布/恢复、断网回归与 Cohort 10/10 严格审计均通过，已准入 L2 Proposal-only；Mutation/L3 继续阻断，见[活动 Work Item](task-loop-003-l1-phase2-to-l2.md)、[执行计划](../plans/task-loop-003-l1-phase2-exec-plan.md)与[准入报告](../verification/task-loop-003-m4-l2-admission.md)。
