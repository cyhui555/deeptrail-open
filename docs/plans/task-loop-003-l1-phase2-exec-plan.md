...
- 公开主仓已登记 7/10、Evidence 完成 4/10；三个未绑定项使当前首次成功率、复用率与闭环率均为 `4/7 = 57.14%`、边界违规 0、连续成功暂为 0。第 5–7 项必须待登记进入受保护 `main` 后运行 Shadow，不能把未执行项记为通过。
...
在第 5–7 项登记进入受保护 `main` 后运行适用 Shadow；随后创建两个既有 Bug 的目标环境发布验证，再完成其余 3 项真实 Work Item 样本。
