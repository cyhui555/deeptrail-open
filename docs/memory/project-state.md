...
- 当前检查门：PR #22–#24 已完成单维护者受保护合并及第 4 项 Shadow；公开 Cohort Evidence 当前 4/10，第 5–7 项已按真实工作预登记、待运行 Shadow，两个既有 Bug 仍待不可变发布与目标环境复验
...
在第 5–7 项登记进入受保护 `main` 后运行适用 Shadow，再进入两个既有 Bug 的不可变发布复验和最后 3 项预登记真实样本。
