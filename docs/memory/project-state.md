...
- 当前检查门：PR #22 已完成单维护者受保护合并实证；PR #23 与第 4 项 `TASK-CI-001` Shadow 证据已完成，公开 Cohort 当前 4/10，两个 Bug 仍待不可变发布与目标环境复验
...
合入三个真实 Full E2E 失败簇并预登记第 5–7 项，再进入两个既有 Bug 的不可变发布复验和其余 3 项预登记真实样本。
